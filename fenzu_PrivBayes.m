...
for rate=1:5 %epsilon2:epsilon3=1:5, 1:4, 1:3, 1:2, 1:1
    ...
    %     filename3=strcat(str3, num2str(ep));
        ...
        avd3_P_sensitive{rate}(ep)=aver_var_dist1;
        avd3_P_nonsensitive{rate}(ep)=aver_var_dist2;
        ...
        %aver_var_dist_av=sum(temp)/10;
        avd2_P_sensitive{rate}(ep)=aver_var_dist1;
        avd2_P_nonsensitive{rate}(ep)=aver_var_dist2;

    end
end

save("avd2_PrivBayes_sensitive.mat",'avd2_P_sensitive')
save("avd2_PrivBayes_nonsensitive.mat",'avd2_P_nonsensitive')
save("avd3_PrivBayes_sensitive.mat",'avd3_P_sensitive')
save("avd3_PrivBayes_nonsensitive.mat",'avd3_P_nonsensitive')